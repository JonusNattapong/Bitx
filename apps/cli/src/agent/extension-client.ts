...
import type { ExtensionMessage, WebviewMessage, ClineAskResponse, ClineMessage, ClineAsk } from "@bitx/types"
...
/**
 * ExtensionClient is the main interface for interacting with the Bitx extension.
 *
 * Basic usage:
 * ```typescript
