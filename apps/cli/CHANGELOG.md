...
All notable changes to the `@bitx/cli` package will be documented in this file.
...
- Improved Bitx Router authentication flow and error messaging

### Fixed

- Removed unnecessary timeout that could cause issues with long-running tasks
- Fixed authentication token validation for Bitx Router provider
