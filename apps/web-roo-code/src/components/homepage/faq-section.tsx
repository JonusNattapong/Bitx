...
const faqs: FAQItem[] = [
	{
		question: "What exactly is Bitx?",
		answer: (
			<>
				Bitx is an open-source, AI-powered coding assistant that runs in VS Code. It goes beyond simple
	...
	{
		question: "How does Bitx differ from Copilot, Cursor, or Windsurf?",
		answer: (
			<>
				Bitx is <strong>open-source and fully customizable</strong>, letting you integrate any AI model you
				...
				browser, and handle deeper tasks. And you&apos;re always in control: Bitx is{" "}
	...
	{
		question: "Is Bitx really free?",
		answer: (
			<>
				Yes! Bitx is completely free and open-source. You&apos;ll only pay for the AI model usage if you use
	...
	},
	{
		...
		answer: (
			<>
				Yes. Because Bitx is an extension in your local VS Code, your code never leaves your machine unless
				you connect to an external AI API. Even then, you control exactly what is sent to the AI model. You can
				use tools like .rooignore to exclude sensitive files, and you can also run Bitx with offline/local
				models for full privacy.
			</>
		),
	},
	{
		question: "Which AI models does Bitx support?",
		answer: (
			<>
				Bitx is fully model-agnostic, giving you the flexibility to work with whatever AI models you prefer.
				...
				connect any other model that follows Bitx&apos;s Model Context Protocol (MCP).
			</>
		),
	},
	{
		question: "Does Bitx support my programming language?",
		answer: (
			<>
				Likely yes! Bitx supports a wide range of languages—Python, Java, C#, JavaScript/TypeScript, Go,
	...
	},
	{
		...
		answer: (
			<>
				Install Bitx from the{" "}
				<a
					href="https://marketplace.visualstudio.com/items?itemName=RooVeterinaryInc.roo-cline-bitx"
					target="_blank"
	...
	},
	{
		...
		answer: (
			<>
				Absolutely. Bitx uses efficient strategies (like partial-file analysis, summarization, or
				...
				<Link href="/enterprise" className="text-primary underline-offset-4 hover:underline">
					Learn more about Bitx for enterprise.
				</Link>
			</>
		),
	},
	{
		...
		answer: (
			<>
				Yes. Bitx was built for enterprise environments. You can self-host AI models or use your own trusted
				provider. All file changes and commands go through permission gating, so nothing runs without your
				approval. And because Bitx is fully open-source, it&apos;s auditable—you can review exactly how it
	...
	{
		question: "Can Bitx run commands and tests automatically?",
		answer: (
			<>
				Yes! One of Bitx&apos;s biggest strengths is its ability to execute commands—always optional and
	...
	},
	{
		...
		answer: (
			<>
				Bitx shines for both serious enterprise development and casual &quot;vibe coding.&quot; You can ask
	...
	{
		question: "Can I contribute to Bitx?",
		answer: (
			<>
				Yes, please do! Bitx is open-source on{" "}
				<a
					href="https://github.com/RooCodeInc/Bitx"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
					GitHub
				...
				<div className="mx-auto mb-24 max-w-3xl text-center">
					<motion.div
						...
						<p className="mt-6 text-lg text-muted-foreground max-w-2xl mx-auto">
							Everything you need to know about Bitx and how it can transform your development
							workflow.
						</p>
					</motion.div>
				</div>
