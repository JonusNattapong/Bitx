 ...
 *
 * This class manages the state for the marketplace view in the Bitx extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the Bitx extensions interface
...
import { MarketplaceItem, MarketplaceInstalledMetadata } from "@bitx/types"
