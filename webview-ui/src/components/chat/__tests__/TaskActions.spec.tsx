import type { HistoryItem } from "@bitx/types"
	...
	useTranslation: () => ({
		t: (key: string) => {
			const translations: Record<string, string> = {
				...
				"chat:task.connectToCloudDescription": "Sign in to Bitx Cloud to share tasks",
				...
				"cloud:cloudBenefitsTitle": "Connect to Bitx Cloud",
...
describe("TaskActions", () => {
	...
	describe("Unauthenticated User Login Flow", () => {
		...
		it("shows connect to cloud option when not authenticated", () => {
			...
			expect(screen.getByText("Connect to Bitx Cloud")).toBeInTheDocument()
