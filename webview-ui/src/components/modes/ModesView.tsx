...
import { ModeConfig, GroupEntry, PromptComponent, ToolGroup, modeConfigSchema } from "@bitx/types"
...
import { TOOL_GROUPS } from "@bitx/tools"
								...
								span: (
									<span
										...
										onClick={() => {
											...
											vscode.postMessage({
												type: "openFile",
												text: `./.bitx/rules-${currentMode.slug}/rules.md`,
												values: {
													create: true,
													content: "",
												},
												...
												span: (
													<span
														...
														onClick={() => {
															...
															vscode.postMessage({
																type: "openFile",
																text: `./.bitx/system-prompt-${currentMode.slug}`,
																values: {
																	create: true,
																	content: "",
																},
