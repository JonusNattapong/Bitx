		...
		<div
			...
			<div
				style={{
					...
					WebkitMaskImage: `url('${imagesBaseUri}/bitx-logo.svg')`,
					WebkitMaskRepeat: "no-repeat",
					WebkitMaskSize: "contain",
					maskImage: `url('${imagesBaseUri}/bitx-logo.svg')`,
