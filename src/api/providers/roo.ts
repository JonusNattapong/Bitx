...
import { rooDefaultModelId, getApiProtocol, type ImageGenerationApiMethod } from "@bitx/types"
...
export class RooHandler extends BaseOpenAiCompatibleProvider<string> {
	...
	/**
	 * Generate an image using Bitx Cloud's image generation API
