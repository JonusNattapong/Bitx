...
// Mock the bitx-config service
vi.mock("../../../../services/bitx-config", () => ({
...
describe("custom-instructions global .bitx support", () => {
	const mockCwd = "/mock/project"
	const mockHomeDir = "/mock/home"
	const globalRooDir = path.join(mockHomeDir, ".bitx")
	const projectRooDir = path.join(mockCwd, ".bitx")
	...
	beforeEach(() => {
		...
		// getAgentsDirectoriesForCwd returns parent directories (without .bitx)
	...
	describe("loadRuleFiles", () => {
		...
		it("should fall back to legacy .roorules file when no .bitx/rules directories exist", async () => {
