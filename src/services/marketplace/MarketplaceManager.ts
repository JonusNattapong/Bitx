...
import type { OrganizationSettings, MarketplaceItem, MarketplaceItemType, McpMarketplaceItem } from "@bitx/types"
...
export class MarketplaceManager {
	...
	private async checkProjectInstallations(metadata: Record<string, { type: string }>): Promise<void> {
		try {
			...
			// Check MCPs in .bitx/mcp.json
			const projectMcpPath = path.join(workspaceFolder.uri.fsPath, ".bitx", "mcp.json")
			try {
