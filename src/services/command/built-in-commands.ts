...
<initialization>
  ...
  <todo_list_creation>
    ...
    1. Check for existing AGENTS.md files
       ...
       - .bitx/rules-code/AGENTS.md (relative to project root)
       - .bitx/rules-debug/AGENTS.md (relative to project root)
       - .bitx/rules-ask/AGENTS.md (relative to project root)
       - .bitx/rules-architect/AGENTS.md (relative to project root)
    ...
    8. Compile/Update AGENTS.md files
       ...
       - Create mode-specific files in .bitx/rules-*/ directories (IN PROJECT ROOT)
...
<analysis_workflow>
  ...
  1. **Discovery Phase**:
     ...
     IMPORTANT: The .bitx folder should be created in the PROJECT ROOT, not system root!
...
<output_structure>
  ...
  <mode_specific_files>
    ...
    - .bitx/rules-code/AGENTS.md (create .bitx in project root, not system root!)
    - .bitx/rules-debug/AGENTS.md (relative to project root)
    - .bitx/rules-ask/AGENTS.md (relative to project root)
    - .bitx/rules-architect/AGENTS.md (relative to project root)
    
    IMPORTANT: The .bitx directory must be created in the current project/workspace root directory,
    ...
    ├── .bitx/                        # IN PROJECT ROOT, NOT SYSTEM ROOT!
    │   ├── rules-code/
    ...
    .bitx/rules-code/AGENTS.md - ONLY non-obvious coding rules discovered by reading files:
    ...
    .bitx/rules-debug/AGENTS.md - ONLY non-obvious debugging discoveries:
    ...
    .bitx/rules-ask/AGENTS.md - ONLY non-obvious documentation context:
    ...
    .bitx/rules-architect/AGENTS.md - ONLY non-obvious architectural constraints:
