...
Bitx 是一個由社群驅動的專案，我們非常重視每一份貢獻。為了簡化協作，我們採用 [「問題優先」的方法](#問題優先方法)，這意味著所有的 [拉取請求 (PR)](#提交拉取請求) 都必須先連結到一個 GitHub 問題。請仔細閱讀本指南。
...
- 如需文件，請造訪 [Bitx 文件](https://github.com/RooCodeInc/Bitx-Docs)。
...
- 使用 [「錯誤報告」範本](https://github.com/RooCodeInc/Bitx/issues/new/choose) 建立一個新錯誤，並提供：
    - 清晰、編號的重現步驟
    - 預期與實際結果
    - Bitx 版本（必需）；如果相關，還需提供 API 提供商/模型
...
透過貢獻，您同意您的貢獻將根據 Apache 2.0 授權進行授權，這與 Bitx 的授權一致。
