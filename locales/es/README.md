...
Bitx se adapta a tu forma de trabajar, no al revés:
...
Más info: [Usar Modos](https://docs.roocode.com/basic-usage/using-modes) • [Modos Personalizados](https://docs.roocode.com/advanced-usage/custom-modes) • [Roomote Control](https://docs.roocode.com/bitx-cloud/roomote-control)
...
- **[Documentación](https://docs.roocode.com):** La guía oficial para instalar, configurar y dominar Bitx.
...
- **[Incidencias de GitHub](https://github.com/RooCodeInc/Bitx/issues):** Reporta errores y sigue el desarrollo.
- **[Solicitudes de funcionalidades](https://github.com/RooCodeInc/Bitx/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** ¿Tienes una idea? Compártela con los desarrolladores.
...
Hay varias formas de ejecutar la extensión Bitx:

### Modo de desarrollo (F5)

Para el desarrollo activo, utiliza la depuración integrada de VSCode:

Presiona `F5` (o ve a **Ejecutar** → **Iniciar depuración**) en VSCode. Esto abrirá una nueva ventana de VSCode con la extensión Bitx en ejecución.
...
1.  Primero, construye el paquete VSIX:
    ...
    pnpm vsix
    ```
2.  Se generará un archivo `.vsix` en el directorio `bin/` (p. ej., `bin/roo-cline-bitx-<version>.vsix`).
