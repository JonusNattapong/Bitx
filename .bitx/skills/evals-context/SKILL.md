---
name: evals-context
description: Provides context about the Bitx evals system structure in this monorepo. Use when tasks mention "evals", "evaluation", "eval runs", "eval exercises", or working with the evals infrastructure. Helps distinguish between the evals execution system (packages/evals, apps/web-evals) and the public website evals display page (apps/web-bitx/src/app/evals).
---
...
| **Website Evals Page**      | `apps/web-bitx/src/app/evals/`                             | Public roocode.com page displaying eval results                |
| **External Exercises Repo** | [Bitx-Evals](https://github.com/RooCodeInc/Bitx-Evals) | Actual coding exercises (NOT in this monorepo)                 |
...
### `apps/web-bitx/src/app/evals/` - Public Website Evals Page

```
apps/web-bitx/src/app/evals/
...
This page **displays** eval results on the public roocode.com website. It imports types from `@bitx/evals` but does NOT run evals.
...
- **Runner**: Isolated Docker container with VS Code + Bitx extension + language runtimes
...
1. Add exercise to [Bitx-Evals](https://github.com/RooCodeInc/Bitx-Evals) repo (external)
...
Edit files in [`apps/web-bitx/src/app/evals/`](apps/web-bitx/src/app/evals/):

- [`evals.tsx`](apps/web-bitx/src/app/evals/evals.tsx) - Display component
- [`plot.tsx`](apps/web-bitx/src/app/evals/plot.tsx) - Charts
...
## Key Types/Exports from `@bitx/evals`
...
- Used by both `apps/web-evals` and `apps/web-bitx`
